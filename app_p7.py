...
st.markdown("<h2 style='text-align: center; color: black;'><strong><u>Analyse</u></strong></h2>",
            unsafe_allow_html=True)
#Analyse
var=['Age','AGE_Tranche', 'AMT_ANNUITY', 'AMT_BALANCE', 'AMT_CREDIT_LIMIT_ACTUAL',
     'AMT_CREDIT_SUM', 'AMT_CREDIT_x', 'AMT_CREDIT_y', 'AMT_DOWN_PAYMENT', 'AMT_DRAWINGS',
     'AMT_GOODS_PRICE', 'AMT_TOTAL_RECEIVABLE', 'ANNUITY_INCOME', 'CNT_CHILDREN', 'CNT_INSTALMENT_FUTURE',
     'CODE_GENDER', 'Comsumer_type_crd', 'CREDIT_DAY_OVERDUE', 'CREDIT_INCOME', 'CREDIT_LENGTH', 
     'CREDIT_TO_GOODS_RATIO', 'DAYS_CREDIT_ENDDATE', 'DAYS_REGISTRATION','DAYS_ID_PUBLISH', 'Diff_day','Diff_pay', 
     'EXT_SOURCE_1', 'EXT_SOURCE_2', 'EXT_SOURCE_3', 'FLAG_OWN_CAR', 'FLAG_OWN_REALTY', 'MONTHS_BALANCE',
     ...
     'NAME_TYPE_SUITE', 'Nombre_active', 'PAYMENT_RATE',
     'REJECT_REASON', 'SK_DPD_DEF', 'SK_ID_CURR', 'Status_active', 'YEAR_EMPLOYED_PERCENT',]
