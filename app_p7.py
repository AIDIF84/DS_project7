...
st.markdown("<h2 style='text-align: center; color: black;'><strong><u>Analyse</u></strong></h2>",
            unsafe_allow_html=True)
#Analyse
var=['Age', 'AMT_ANNUITY', 'AMT_BALANCE', 'AMT_CREDIT_LIMIT_ACTUAL',
     ...
     'CREDIT_TO_GOODS_RATIO', 'DAYS_CREDIT_ENDDATE', 'DAYS_REGISTRATION', 'Diff_day','Diff_pay', 
     ...
     'NAME_TYPE_SUITE', 'Nombre_active', 'PAYMENT_RATE','DAYS_ID_PUBLISH','AGE_Tranche',
